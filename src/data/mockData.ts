...
export const INITIAL_LABELS: Label[] = [
  { id: 'l1', name: 'Urgent Follow-up', color: '#EF4444', createdBy: 'u1' },
  { id: 'l2', name: 'Hot Lead', color: '#F59E0B', createdBy: 'u1' },
  { id: 'l3', name: 'VIP Client', color: '#8B5CF6', createdBy: 'u1' },
  { id: 'l4', name: 'Printing Inquiry', color: '#0F766E', createdBy: 'u1' },
  { id: 'l5', name: 'Machinery Buyer', color: '#0284C7', createdBy: 'u1' },
];
